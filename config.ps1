Write-Host  -ForegroundColor Cyan "Starting OSDCloud for Windows 10 24h2 sv-se"
...
Write-Host  -ForegroundColor Cyan "Starting OSDCloud with Windows 10 24h2 sv-se"
Start-OSDCloud -OSVersion 'Windows 10' -OSLanguage sv-se -OSBuild 22H2 -OSEdition Pro -ZTI
